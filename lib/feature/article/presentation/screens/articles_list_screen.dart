...
import 'package:novanews/feature/article/presentation/cubit/article_state.dart';




// كلاس إدارة حالات الـ Cubit (تم إصلاح الـ watch وتعديل الاسم)
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ArticleCubit, ArticleState>(
      builder: (context, state) {
        // الاعتماد مباشرة على الـ state الممررة في الـ builder وحذف سطر الـ watch الخاطئ
...
// كلاس مستقل للنص الترحيبي العلوي المتناسق
...
// كلاس مستقل لعرض كارت المقال بدقة
